...
const SEOHead = () => {
  useEffect(() => {
    ...
    updateMeta('description', 'Dictionary, Thesaurus & AI Tutor - A free-to-start study app for students. Focus timer with Pomodoro technique, study planner, notes with flashcards, and an AI study mentor. Alternative to Chegg.');
    updateMeta('keywords', 'focus timer, Pomodoro, college planner, homework helper, dictionary, free study app for college, alternative to Chegg, AI note taker, student companion, thesaurus, AI tutor, study app, flashcards');
    ...
    updateMeta('og:description', 'A free-to-start study app for students. Focus timer, Pomodoro, study planner, notes with flashcards, and an AI study mentor.', true);
    ...
    updateMeta('twitter:description', 'Dictionary, Thesaurus & AI Tutor - free to start. Focus timer, Pomodoro, study planner.');
...
const LandingPage = () => {
  ...
  const features = [
    {
      ...
      description: "Fast definitions while you study. Look up any word without losing your flow.",
      color: "text-cyan-400",
      keywords: ["dictionary", "homework helper"]
    },
    {
      icon: Sparkles,
  ...
  const competitors = [
    ...
    { name: "Student Companion", price: "Free plan", features: [true, true, true, true, true], highlight: true }
  ];
  ...
  const faqs = [
    {
      question: "Is Your Student Companion free?",
      answer: "The core study tools — task tracker, study planner, focus timer, notes with flashcards, and general AI mentor chat — are free. Optional subscriptions and course packs unlock specialized content for your major."
    },
    {
    ...
    },
    {
      ...
      answer: "Offline mode is in development. The current version requires an internet connection."
    },
    {
      question: "Is this a good alternative to Chegg?",
      answer: "Unlike Chegg ($19.95/mo) or Course Hero ($39.99/mo), Student Companion's core tools are free — dictionary, thesaurus, focus timer, planner, and AI mentor basics. Paid course packs are optional, not required."
    }
  ];
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <Badge className="mb-6 bg-accent/10 text-accent border-accent/20 hover:bg-accent/20">
              ...
              Focus Timer • Study Planner • AI Mentor
            </Badge>
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-4">
              Plan, focus, and study smarter — everything in one place.
            </p>

            {/* ASO Tagline */}
            <p className="text-base sm:text-lg text-accent/80 mb-8 font-medium">
              Dictionary, Thesaurus & AI Tutor — Free to Start
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12">
              <div className="text-center">
                <p className="text-3xl sm:text-4xl font-bold text-foreground">25 min</p>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Core Study Tools</p>
              </div>
              <div className="w-px h-12 bg-border/50 hidden sm:block" />
              <div className="text-center">
          ...
          <div className="mt-16 relative">
            ...
            <div className="relative rounded-xl overflow-hidden border border-border/30 shadow-2xl shadow-accent/10">
              <img 
                ...
                alt="College students using Your Student Companion - a study app with focus timer, Pomodoro technique, and study planner"
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-background/90 via-background/50 to-transparent flex items-center">
                <div className="p-8 sm:p-12 max-w-lg">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Pomodoro focus timer, study planner, notes with flashcards, AI mentor — everything you need to succeed.
                  </p>
                  {isSignedIn ? (
                    <Link to="/app">
                      <Button className="bg-accent text-accent-foreground hover:bg-accent/90">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Focus timer, study planner, notes with flashcards, and an AI mentor — all in one app, free to start.
            </p>
          </div>
      ...
      <section id="pricing" className="py-20 sm:py-28 bg-card/30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">
              More Tools. <span className="text-accent">Less Cost.</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Chegg, Quizlet, Course Hero — subscriptions add up fast. Our core study tools are free; specialized course packs are optional.
            </p>
          </div>
          ...
          <div className="mt-12 text-center">
            ...
            <p className="mt-4 text-sm text-muted-foreground">No credit card required. Free plan included.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-28 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-6">
            Ready to <span className="text-accent">Study Smarter?</span>
          </h2>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Focus timer, study planner, notes with flashcards, and an AI mentor — free to start.
          </p>
          {isSignedIn ? (
            <Link to="/app">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} Your Student Companion.
            </p>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-border/30 text-center">
            <p className="text-xs text-muted-foreground/60 max-w-3xl mx-auto">
              Your Student Companion: Study & Focus is a free-to-start study app for students. Features include a focus timer with Pomodoro technique,
              study planner, task tracker, notes with flashcards, dictionary, academic thesaurus, and an AI study mentor. An affordable alternative
              to Chegg, Quizlet, and Course Hero.
            </p>
          </div>
        </div>
      </footer>
